...
function draw() 
{
  ...
  panel1_voltage = round(absorbA*0.5)
  panel2_voltage = round(absorbB*0.5)
  
  //if the them is more than 30 and power gen is greater than 4, turn on fan1 
...
function charge2(rayB){
 
  rayB.remove();
  absorbB +=1;
}

function temp_rise(rays){
  temp +=1;
  rays.remove();
